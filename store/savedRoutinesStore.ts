...
import { useCustomExercisesStore } from './customExercisesStore';
...
export interface SavedRoutine {
    ...
    exercises: Exercise[];
    createdAt: Date;
    scheduleType?: 'specific_days' | 'interval' | null;
...
export const useSavedRoutinesStore = create<SavedRoutinesState>((set, get) => ({
    routines: [],
    loading: false,
    ...
    fetchRoutines: async () => {
        ...
        try {
            ...
            if (data) {
                const formattedRoutines: SavedRoutine[] = data.map((r: any) => {
